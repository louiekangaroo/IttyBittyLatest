            ...
            <div class="column-div">
                ...
                <div class="news_container">
                    <div class = "news-image">
                        <img src="images/alila/samp.JPG" alt="Mountain View" style="width:130px;height:130px">
                    </div>
                    <div><h2 class="news-header">Regular coffee drinkers have 'cleaner' arteries</h2>
                        <p class="news-body">In the study, the researchers used medical scans to assess heart health.Specifically, they were looking for any disease of the arteries supplying the heart - the coronary arteries.In coronary heart disease, ..</p>
                ...
                <div id="modal">
                    <div class="modal-content">
                        <div class="header">
                            <h2 class="news-header2">Regular coffee drinkers have 'cleaner' arteries</h2>
                        </div>
                        <div class="copy">
                            <div class = "news-image">
                                <img src="images/alila/samp.JPG" class="img-responsive" alt="Mountain View" style="width:300px;height:300px">
                            </div>                        
                        <p class="news-body"> In the study, the researchers used medical scans to assess heart health.Specifically, they were looking for any disease of the arteries supplying the heart - the coronary arteries.In coronary heart disease, the coronary arteries become clogged by the grad Some studies have linked consumption to heart risk factors, such as raised cholesterol or blood pressure, while others suggest the beverage may offer some heart protection Some studies have linked consumption to heart risk factors, such as raised cholesterol or blood pressure, while others suggest the beverage may offer some heart protection Some studies have linked consumption to heart risk factors, such as raised cholesterol or blood pressure, while others suggest the beverage may offer some heart protection</p>
                            <div class = "clear"></div>
                        </div>
